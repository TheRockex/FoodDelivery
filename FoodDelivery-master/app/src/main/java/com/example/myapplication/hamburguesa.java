...
public class hamburguesa extends AppCompatActivity {
    ...
    public void changeToRegistrar(View view) {
        Intent nIntent = new Intent(hamburguesa.this, Comidas.class);
        startActivity(nIntent);
    }

    public void AnyadirHamburguesa() {

        //Añadir hamburguesa a la base de datos
        String nameString = "Hamburguesa";
        double precioInt = 11.50;


        DatabaseAux aux = new DatabaseAux(hamburguesa.this);
        ...
        if(res >= 0) {
            ...
            Toast.makeText(this, "Fallo al añadirr", Toast.LENGTH_SHORT).show();
        }
